...
public class CuentaCuentos {
	...
	public static String cuentoZorro() {
        ...
        sb.append("\nHabia una vez un zorro que caminaba, sediento, por el bosque. "
                + "Mientras lo hacia vio en lo alto de la rama de un arbol un racimo "
                + "de uvas, las cuales deseo al instante al servirle para refrescarse "
                + "y apagar su sed. El zorro se acerco al árbol e intentó alcanzar las "
